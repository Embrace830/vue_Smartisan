            ...
            <div class="gray-box">
                        ...
                        <div class="cart-group js-cart-group">
                            <div class="cart-items" v-for="item,index in checkedGoods">
                                <div class="items-thumb">  
                                    <a href="javascript:;" target="_blank"><img :src="item.ali_image+'?x-oss-process=image/resize,w_80'"></a>  
                                </div>
                ...
                <div class="box-inner"> 
                    <div class="last-payment clear"> 
                        <span class="jianguo-blue-main-btn big-main-btn payment-blue-bt fn-right js-checkout" @click="submitOrder"> <a>提交订单</a> </span> <span class="prices fn-right">应付金额： <em>¥ {{checkedPrice+freight}}.00</em></span> 
                    </div> 
                </div>
            </div>
        </div>
