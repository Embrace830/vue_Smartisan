			...
			<div class="cart-box">
								...
								<div class="cart-top-items" v-for="(item,index) in carPanelData">
									<div class="cart-items">
										...
										<div class="items-thumb">
											<img :src="item.ali_image+'?x-oss-process=image/resize,w_80'">
				...
				<div  class="cart-bottom-bg fix-bottom" v-if="count>0">
					...
					<div class="shipping">
                        ...
                        <router-link tag="span" to="/checkout" class="jianguo-blue-main-btn big-main-btn js-checkout" :class="{'disabled-btn':checkedCount<=0}" @click="checkOutHandle"><a>现在结算</a></router-link>
					</div>
				</div>
			</div>
		</div>
