		...
		<div class="item-box">
			<div class="gallery-wrapper">
				<div class="gallery">
					<div class="thumbnail">
						<ul>
							<li :class="{'on':index==imgIndex}" v-for="img,index in itemsInfo.ali_images" @click="tableImg(index)"><img :src="img+'?x-oss-process=image/resize,w_54'"></li>
						</ul>
					</div>
					<div class="thumb">
						<ul>
							<li :class="{'on':index==imgIndex}"  v-for="img,index in itemsInfo.ali_images"><img :src="img+'?x-oss-process=image/resize,w_440'"></li>
						</ul>
					</div>
				</div>
			</div>
					...
					<div class="sku-dynamic-params clear">
						...
						<ul class="params-colors">
							<li :class="{'cur':color.id==$route.query.itemId}" v-for="color,index in itemsInfo.sku_list">
								<router-link :to="{name: 'Item', query: {itemId:color.id}}" :title="color.color"><img :src="'http://img01.smartisanos.cn/'+color.image+'20X20.jpg'"></router-link>
							</li>
						</ul>
					</div>
					<div class="sku-dynamic-params clear">
